    ...
    public static class ModSlotColors
    {
        ...
        public static string GetModDescription(ModType type)
        {
            return type switch
            {
                ...
                ModType.Burn => "Fire DOT: 3 dmg/s for 3s (stacks)",
                ModType.Frost => "Slow: -35% speed for 2s (stacks)",
                ModType.Shock => "Chains to 1 nearby enemy (stacks)",
                ModType.Void => "Deals 5% of target's current HP (stacks)",
                ModType.Leech => "Heals objective for 12% of damage (stacks)",
